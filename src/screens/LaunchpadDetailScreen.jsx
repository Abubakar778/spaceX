          ...
          {rockets.map((rockets) => (
            ...
            <div key={rockets.id} >
                ...
                <div className="col-md-5 d-inline-block ">
                  <img src={rockets.images.large[0]} alt="source img" className='w-100 h-100 ' />
                </div>
...
export default LaunchpadDetailScreen;
